...
<p>Whather you supply attachments as base64-encoded strings or as Blobs/Buffers, under the hood PouchDB will try to store them in <a href="/faq.html#data_types">the most efficient way</a>. All of the &quot;write&quot; APIs &ndash; <code>putAttachment()</code>, <code>put()</code>, <code>bulkDocs()</code>, and <code>post()</code> &ndash; accept either base64 strings or Blobs/Buffers.</p>
